...
using Owin;
using Sample.Web.API.OAuth.OAuth.Providers;

[assembly: OwinStartup(typeof(Sample.Web.API.OAuth.OAuth.Startup))]
namespace Sample.Web.API.OAuth.OAuth
{
    public class Startup
    {
        ...
        private void ConfigureOAuth(IAppBuilder appBuilder)
        {
            ...
            // Bu maliyetin yanı sıra Bearer token'a göre kaynak alış verişi daha güvenlidir. çünkü client her request'inde veriyi hmac ile imzalayıp verileri kriptolu şekilde göndermelidir.
